          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-4">
                Nos solutions d'isolation acoustique et anti-vibratoire sont conçues pour réduire 
                efficacement les nuisances sonores et les vibrations dans les bâtiments résidentiels 
                et tertiaires.
              </p>
