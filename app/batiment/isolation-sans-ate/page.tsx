...
const IsolationSansATE = () => {
  ...
  return (
    <Layout>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
                Isolation acoustique sous chape sans ATE
              </h1>
              <p className="text-lg text-muted-foreground mb-4">
                Notre gamme TOP offre des solutions d'isolation acoustique sous chape 
                sans agrément technique européen, adaptées aux applications spécifiques 
                ne nécessitant pas de certification ATE.
              </p>
              <p className="text-lg text-muted-foreground">
                Ces produits garantissent une excellente réduction des bruits d'impact 
                tout en offrant une flexibilité d'utilisation pour des projets variés, 
                de la rénovation aux constructions neuves.
              </p>
            </div>
            <div className="aspect-square overflow-hidden rounded-3xl">
              <img 
                src={isolationSansAte.src} 
                alt="Isolation acoustique sous chape sans ATE"
      ...
      {/* Explore More */}
      <ExploreMore currentPath="/batiment/isolation-sans-ate" />
    </Layout>
  );
};

export default IsolationSansATE;