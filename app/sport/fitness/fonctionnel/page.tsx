  ...
  return (
    <Layout>
      ...
      <FeatureCardGrid
        ...
        heading="Pourquoi nos sols pour entraînement fonctionnel"
        items={features}
      />
      ...
      <section className="py-16 bg-foreground">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sportProducts.filter((p) => !["sportec-mountain", "sportec-icemat", "sportec-base-fr", "sportec-base-ms"].includes(p.slug)).map((product, index) => (
              <motion.div
                key={product.slug}
                initial={{ opacity: 0, y: 12 }}
                whileInView={{ opacity: 1, y: 0 }}
