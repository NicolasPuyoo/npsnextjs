  ...
  return (
    <Layout>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/80">
              Revêtements optimisés pour les terrains de basketball.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <FeatureCardGrid
        ...
        heading="Pourquoi nos sols pour basket"
        items={features}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-white/70 max-w-2xl mx-auto">
              Découvrez notre gamme de revêtements adaptés aux terrains de basketball
            </p>
          </motion.div>
      ...
      <ExploreMore currentPath="/sport/outdoor/basket" />
    </Layout>
  );
};
