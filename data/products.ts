...
{ 
  ...
  { name: "ULTRAGYM", slug: "vibrafoam", image: vibrafoamBat.src, category: "batiment", subcategory: "isolation-acoustique-antivibratoire",
    details: {
      ...
      specifications: [
        ...
        { label: "Charge admissible", value: "Variable selon dureté (0,075 à 1,5 N/mm² standard ; jusqu'à 6,0 N/mm² avec variantes HL 3000 et HL 6000)" },
  ...
  { name: "DAMTEC® BLACK UNI B1", slug: "damtec-black-uni-b1", image: damtecBlackUniB1.src, category: "batiment", subcategory: "isolation-revetements-sols",
    details: {
      description: "DAMTEC® black uni B1 est la version ignifugée de la sous-couche acoustique BLACK UNI. Classement feu Bfl-s1, conforme aux exigences des ERP, IGH et bâtiments commerciaux. Installation en pose libre sous revêtements stratifiés, parquets, moquette, linoleum et PVC.",
      specifications: [
        { label: "Matériau", value: "Granulats fins de mousse de polyuréthane et granulats de liège liés avec un agent PU polyuréthane" },
        { label: "Couleur", value: "noire/grise/beige/marron (PU), beige (liège)" },
        { label: "Largeur de bande", value: "1.000 mm (± 1,5 %)" },
        ...
        { label: "Classement feu", value: "Bfl-s1 (EN 13501-1)" },
  ...
  { name: "DAMTEC® ESTRA", slug: "damtec-estra", image: damtecEstra8mm.src, category: "batiment", subcategory: "isolation-sous-chape",
    details: {
      description: "DAMTEC® estra est une sous-couche en granulat de caoutchouc lisse, destinée à l'isolation des bruits d'impact, à l'amortissement des vibrations et au découplage solidien. Elle est utilisée pour différentes applications, par exemple sous chape flottante ou sous fondations des machines, en bâtiments résidentiels, tertiaires ou commerciaux.",
      specifications: [
  ...
  { name: "DAMTEC® ESTRA 3D", slug: "damtec-estra-3d", image: damtecEstra3D.src, category: "batiment", subcategory: "isolation-sous-chape",
    details: {
      description: "DAMTEC® estra 3D est une sous-couche profilée d'un seul côté pour pose sous chapes flottantes, conçue pour les bâtiments résidentiels, tertiaires et commerciaux. Idéale aussi pour les supermarchés et les entrepôts grâce à sa résistance élevée à la compression. Isolation acoustique durable et fiable.",
      specifications: [
        { label: "Matériau", value: "Granulats de caoutchouc de haute qualité agglomérés par un liant élastomérique de polyuréthane" },
        { label: "Couleur", value: "noire/multicolor" },
        { label: "Largeur de bande", value: "1.250 mm (± 1,5 %)" },
...
export const sportProducts: Product[] = [
  ...
  { name: "SPORTEC® BASE FR", slug: "sportec-base-fr", image: sportecBaseFr.src, category: "sport",
    details: {
      description: "SPORTEC® base FR est une dalle de protection coupe-feu pour zones d'haltérophilie et de chute de poids en centres de fitness ou installations sportives exigeantes (ERP). Composition à base de granulés EPDM agglomérés au polyuréthane. Classement feu Cfl-s1 (B1).",
      specifications: [
        { label: "Matériau", value: "Granulés d'EPDM agglomérés avec élastomère de polyuréthane" },
        { label: "Surface", value: "Lisse à pores ouverts" },
        { label: "Face inférieure", value: "Ondulée renforcée" },
        { label: "Épaisseur", value: "30 mm (± 2 mm)" },
        { label: "Format", value: "Dalles 500 × 500 mm ou 1000 × 500 mm" },
        { label: "Classement feu", value: "Cfl-s1 (B1) selon EN 13501-1" },
        { label: "Application", value: "Protection de substrat sous zones d'haltérophilie et de chute de poids en ERP" },
        { label: "PCF (empreinte carbone)", value: "17,1 kg CO₂e/m²" },
  ...
  { name: "SPORTEC® BASE MS", slug: "sportec-base-ms", image: sportecBaseMs.src, category: "sport",
    details: {
      description: "SPORTEC® base MS est une dalle de protection en granulés de caoutchouc recyclé de pneus, conçue pour absorber les chocs dans les zones d'haltérophilie et de chute de poids en centres de fitness ou salles de force. Sous-face ondulée renforcée pour une excellente stabilité.",
      specifications: [
        ...
        { label: "Format", value: "Dalles 500 × 500 mm, 1000 × 500 mm ou 1000 × 1000 mm" },
        { label: "Classement feu", value: "Efl (B2) selon EN 13501-1" },
        { label: "Application", value: "Protection de substrat sous zones d'haltérophilie et de chute de poids" },
        { label: "Certifications", value: "Étiquetage sanitaire français A+" },
      ],
